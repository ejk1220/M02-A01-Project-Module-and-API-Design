...
public class VisitorMap extends javax.swing.JFrame {
 private UpdateQueueUI view;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wallyland Visitor Map");
        ...
        jButton2.setText("Rides and Queues");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorMap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorMap().setVisible(true);
            }
        });
    }
